        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-2 font-serifText text-[15px] text-ink/80">
              {socials.map((s) => (
                <li key={s.label}>
                  <a href={s.href.startsWith("http") ? ext(s.href) : s.href} target={s.href.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer" className="hover:text-oxblood transition-colors">
